 ...
 */
package models.db.test_schema.students.tables;


import java.util.function.Function;

import models.db.test_schema.students.TestSchema;
...
public class Students extends TableImpl<StudentsRecord> {
    ...
    /**
     * The reference instance of <code>test_schema.students</code>
     */
    ...
    /**
     * The column <code>test_schema.students.student_id</code>.
     */
    public final TableField<StudentsRecord, Integer> STUDENT_ID = createField(DSL.name("student_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>test_schema.students.student_name</code>.
     */
    public final TableField<StudentsRecord, String> STUDENT_NAME = createField(DSL.name("student_name"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>test_schema.students.faculty</code>.
     */
    public final TableField<StudentsRecord, String> FACULTY = createField(DSL.name("faculty"), SQLDataType.VARCHAR(100), this, "");
    ...
    /**
     * Create an aliased <code>test_schema.students</code> table reference
     */
    ...
    /**
     * Create a <code>test_schema.students</code> table reference
     */
    public Students() {
